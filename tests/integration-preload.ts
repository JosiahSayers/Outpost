...
// `bun run test:integration`. Handles the database reset/seed/snapshot
// lifecycle that integration tests need; unit and component tests never
// load this file, so they skip it entirely.
